  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(268, 82%, 60%, 0.3) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(344, 91%, 60%, 0.2) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(268, 82%, 60%, 0.2) 0px, transparent 50%)',
      },
    },
  },
  plugins: [],
